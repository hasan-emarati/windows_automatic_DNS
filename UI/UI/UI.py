...
class QuickSetDNSApp(ctk.CTk):
    ...
    def create_home_page(self):
        ...
        self.combo_box = ctk.CTkComboBox(
            self.home_frame, values=["Option 1", "Option 2", "Option 3"],
            fg_color=self.color, border_color=self.color, border_width=8,
            corner_radius=20, dropdown_fg_color=self.color,
